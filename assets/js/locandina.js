...
(function () {
  ...
  // I CORSI stavano qui fino al 09/09/2026, con un img.co-loc dentro il
  // <details>. Adesso la loro locandina e' una pillola .event-act come nei
  // centri, quindi la prende il selettore qui sopra: il caso si e' spostato,
  // non e' sparito. Il nome morto si toglie perche' un selettore che non
  // corrisponde piu' a niente e' una riga che nessuno sa piu' se serve.
  var IMG = 'img.ev-loc';
