...
/* La fascia illustrata (24/09/2026): parte da .ev-hero--img di PAGINA_CSS (la
   stessa di /halloween.html), ma SENZA il velo scuro da sinistra - il disegno
   e' gia' in penombra a sinistra, dove sta il testo, e il velo ci aggiungeva
   un alone blu (Patrick). Al suo posto un'ombra sotto le lettere.
   Sotto i 900px il disegno scende sotto il testo, in una versione sua
   (luoghi-m, di giorno e piu' alta), come la fascia di eventi.html: blu pieno
   fin dove il disegno comincia, poi sfuma nel cielo. */
.lg-hero.ev-hero--img::before{background:var(--fascia) center/cover no-repeat}
.lg-hero.ev-hero--img h1,.lg-hero.ev-hero--img p,.lg-hero.ev-hero--img .ev-crumb{
  text-shadow:0 1px 3px rgba(0,0,0,.55),0 0 12px rgba(0,0,0,.35)}
@media(max-width:900px){
  .lg-hero.ev-hero--img{padding-bottom:calc(56.4vw - 8px);background:#0e1422}
  .lg-hero.ev-hero--img::before{background:linear-gradient(180deg,#0e1422 0%,#0e1422 calc(100% - 56vw),
    rgba(14,20,34,.8) calc(100% - 50vw),rgba(14,20,34,.45) calc(100% - 44vw),
    rgba(14,20,34,.18) calc(100% - 38vw),rgba(14,20,34,0) calc(100% - 32vw)),
    var(--fascia-m,var(--fascia)) center bottom/100% auto no-repeat,#0e1422}
  .lg-hero.ev-hero--img h1,.lg-hero.ev-hero--img p,.lg-hero.ev-hero--img .ev-crumb{text-shadow:none}
}
...
{nav}
<main id="contenuto">
<header class="page-hero ev-hero lg-hero ev-hero--img" style="--fascia:url(/assets/images/stagioni/luoghi-1600.webp);--fascia-m:url(/assets/images/stagioni/luoghi-m.webp)">
...
# /piscine.html e' stata TOLTA il 24/09/2026 (Patrick). Era nata il 17/08 come
# scommessa dichiarata ("se fra sei mesi non prende niente, toglierla, non
# moltiplicarla"): dopo cinque settimane faceva 1.352 impressioni e 10 clic in
# 28 giorni, quasi tutte ricerche su UNA piscina precisa ("piscina Quattordio"),
# cioe' lo stesso problema di luoghi.html. Il file resta come rimando a
# /luoghi.html (schema di ilpiattosano.html), cosi' i link vecchi non danno 404.
# Il generatore non la scrive piu': render_piscine() e' in git log (b5f53645d).
